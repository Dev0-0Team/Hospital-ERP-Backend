...
namespace Hospital_ERP_Backend.Infrastructure.RepoPatients.Bass
{
    public class GeneralRuleCommand<T> : IBaseCommandRepository<T> where T : BaseEntity
    {

        protected readonly HospitalDbContext _dbContext;
        protected GeneralRuleCommand(HospitalDbContext dbContext)
        {

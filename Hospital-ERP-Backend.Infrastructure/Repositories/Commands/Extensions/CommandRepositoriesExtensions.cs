...
namespace Hospital_ERP_Backend.Infrastructure.Repositories.Commands.Extensions
{
    public static class CommandRepositoriesExtensions
    {
        public static IServiceCollection AddCommandRepositoriesExtension(this IServiceCollection services)
        {
            ...
            services.AddScoped<IBaseCommandRepository<EmergencyCase>, EmergencyCasesCommandRepository>();
            ...
            services.AddScoped<IBaseCommandRepository<Notification>, NotificationsCommandRepository>();
            services.AddScoped<IBaseCommandRepository<InvoiceItem>, InvoiceItemCommandRepository>();
            services.AddScoped<IBaseCommandRepository<Invoice>, InvoiceCommandRepository>();

...
namespace Hospital_ERP_Backend.Application.Features.Medications.Commands.UpdateMedication
{
    internal class UpdateMedicationService : IRequestHandler<UpdateMedicationRequest, UpdateMedicationResponse>
    {
        ...
        public UpdateMedicationService(IValidator<UpdateMedicationRequest> validator, IBaseCommandRepository<Medication> medicationRepository)
        {
        ...
        private async Task<UpdateMedicationResponse> UpdateMedicationAsync(UpdateMedicationRequest request)
        {
            ...
            var medication = await _medicationRepository.FindAsync(request.Id);

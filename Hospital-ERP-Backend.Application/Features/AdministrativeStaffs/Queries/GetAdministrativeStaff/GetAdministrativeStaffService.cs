...
{
    internal class GetAdministrativeStaffService : IRequestHandler<GetAdministrativeStaffRequest, GetAdministrativeStaffResponse>
    {
        ...
        public async Task<GetAdministrativeStaffResponse> Handle(GetAdministrativeStaffRequest request, CancellationToken cancellationToken)
        {
            return await GetAdministrativeStaffAsync(request);
        }

        private async Task<GetAdministrativeStaffResponse> GetAdministrativeStaffAsync(GetAdministrativeStaffRequest request)
        {

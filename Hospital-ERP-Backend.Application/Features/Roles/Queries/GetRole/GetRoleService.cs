...
{
    internal class GetRoleService : IRequestHandler<GetRoleRequest, GetRoleResponse>
    {
        ...
        {
            return await GetRoleAsync(request);
        }

        private async Task<GetRoleResponse> GetRoleAsync(GetRoleRequest request)
        {
